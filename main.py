...
client = AsyncIOMotorClient("mongodb+srv://Anudeep:nULY1apnFAbOSZhj@backendinterntask.9o6rwm0.mongodb.net/?retryWrites=true&w=majority&appName=BackendInternTask")
